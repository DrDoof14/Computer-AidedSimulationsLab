...
#then we should compute and store the finger prints inside of a hashtable 
...
print(f' The theoratical value for epsilon is equal to {new_epsilon}\n')
...
#########
#===================4th question==============================
in4=input('The answer to the 4th question of the fingerprints set is available in the report in details\n')
...
#but any value more than 61 would be unnecessary, so the value 70 is chosen for sake of a better visualization
bloom_filter_dict={}
...
#         memory_dict[k] = {(a.count(1)/n)**k:asizeof.asizeof(a)/1024} to also have the sizes (sizes are equal to theory)
